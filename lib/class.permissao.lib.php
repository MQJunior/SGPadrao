 ...
 */  
  public function ChecarPermissaoSys(){
    ...
    if(!$this->ChecarPermissao($tmpCodigoUsuario, $tmpEntidade, $tmpAcao)){
      ...
      $this->SISTEMA_['ERROR']['PERMISSAO']['MENSAGEM'] = "USUÁRIO SEM PERMISSAO PARA O COMANDO: ".$tmpEntidade." -> ".$tmpAcao;
 ...
 */  
  ...
  private function ConectaDB(){
    if ($this->DataBaseLink == null)
      $this->DataBaseLink = new ConexaoDB($this->SISTEMA_['CONFIG']['PERMISSAO']['DATABASE']['HOSTNAME']

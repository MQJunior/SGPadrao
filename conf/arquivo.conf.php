...
$SISTEMA['CONFIG']['ARQUIVO']['LOCAL']['ARMAZENAR'] = '/sistema/sistemas/SGPadrao/datafiles/';
$SISTEMA['CONFIG']['ARQUIVO']['LOCAL']['EXIBIR'] = '/sistema/www/SGPadrao/files/';
isset($_SERVER["SERVER_ADDR"])?$SISTEMA['CONFIG']['ARQUIVO']['LOCAL']['LINK'] = 'http://'.$_SERVER["SERVER_ADDR"].'/SGPadrao/files/':$SISTEMA['CONFIG']['ARQUIVO']['LOCAL']['LINK'] = 'sistema/sistemas/SGPadrao/files/';;
